	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">perpustakaan digital</span>
              ...
              <i class="align-middle" data-feather="server"></i> <span class="align-middle">ulasan</span>
            </a>
					</li>
					<li class="sidebar-item">
						<a class="sidebar-link" href="?page=laporan">
              <i class="align-middle" data-feather="layout"></i> <span class="align-middle">laporan</span>
            </a>
					</li>
					<?php 
					}else{
              ...
              <i class="align-middle" data-feather="bookmark"></i> <span class="align-middle">peminjaman</span>
            </a>
					</li>
					<li class="sidebar-item">
						<a class="sidebar-link" href="?page=ulasan">
				...
				<div class="container-fluid">
					<div class="row text-muted">
						<div class="col-6 text-start">
							<p class="mb-0">
								<a class="text-muted" href="https://ukk.io/" target="_blank"><strong>ukk</strong></a> - <a class="text-muted" href="https://adminkit.io/" target="_blank"><strong>spp &copy; by admin</strong></a>
							</p>
						</div>
